...
import mailsImg from './images/mails.png';
...
export default class Home extends Component {
    ...
    CountUp() {
        let imgSrc = ['mails', 'like', 'message', 'orders'];
        let imgs = [mailsImg, likeImg, messageImg, ordersImg];
        let imgName = ['Mails', 'Like', 'Message', 'Orders'];
        let count = ['345', '465', '32', '285'];
    ...
    render() {
        ...
        return (
            <div>
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Card title="时间轴" className="card-timeline">
                            <Timeline mode="alternate">
                                <Timeline.Item>创建网站 2021-02-15</Timeline.Item>
                                <Timeline.Item color="green">登录验证 2021-02</Timeline.Item>
                                <Timeline.Item color="green" >
                                    技术验证 2021-03
                        </Timeline.Item>
                                <Timeline.Item color="green">路由配置 2021-03</Timeline.Item>
                                <Timeline.Item>版本迭代 2021-03</Timeline.Item>
                    ...
                    <Col span={12}>
                        <Card className="card-todos" title="任务表">
                            <ToDo />
                        </Card>
                    </Col>
                </Row>
